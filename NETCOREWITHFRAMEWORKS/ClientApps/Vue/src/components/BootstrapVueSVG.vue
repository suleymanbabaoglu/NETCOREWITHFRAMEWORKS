  ...
  >
    <defs>
      <filter
        ...
        height="200%"
      >
        <feOffset in="SourceAlpha" dx="-10" dy="25" result="ALPHA1"></feOffset>
        <feMorphology
          in="ALPHA1"
          operator="dilate"
          radius="15"
        ...
        <feGaussianBlur
          ...
          result="DROP"
        ></feGaussianBlur>
        <feFlood in="DROP" flood-color="#333" result="SOLID"></feFlood>
        <feComposite
          in="DROP"
          in2="SOLID"
          operator="in"
    ...
    <g>
      <g filter="url(#logo-shadow)" class="logo-dark-v">
        <path
          fill="#34495E"
          d="M747 311L602 562 458 311H227l375 651 376-651z"
        ></path>
      </g>
      <g filter="url(#logo-shadow)" class="logo-purple-v">
        <path
          fill="#563D7C"
          fill-rule="nonzero"
      ...
      <g filter="url(#logo-shadow)" class="logo-green-v">
        <path
          fill="#41B883"
